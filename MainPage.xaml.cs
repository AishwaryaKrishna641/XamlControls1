...
namespace XamlControls1
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void MyCalenderView_SelectedDatesChanged(CalendarView sender, CalendarViewSelectedDatesChangedEventArgs args)
        {
        ...
        private void MyFlyoutButton_Click(object sender, RoutedEventArgs e)
        {
